...
export const metadata = {
  title: 'About | Perugi Partners',
  description: 'Financial clarity for the modern entrepreneur.',
}
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection animation="fade-left">
              <span className="text-xs uppercase tracking-[0.15em] text-muted-foreground mb-4 block">
                About Perugi Partners
              </span>

              <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-[0.95]">
                I used to only know my numbers at <span className="text-emerald-500">tax season</span>.
              </h1>

              <p className="text-lg text-muted-foreground mb-8 max-w-lg">
                Perugi Partners exists because I experienced firsthand what it feels like to run a business with blind spots.
                Everything looks fine until the numbers tell a different story.
              </p>
      ...
      <section className="w-full py-20 lg:py-28 bg-card/30">
        <div className="w-full px-6 lg:px-12 max-w-3xl mx-auto">
          ...
          <AnimatedSection className="space-y-6 text-lg leading-relaxed">

            <p>
              I used to run a business where everything felt like it was working.
              Sales were coming in, clients were paying, things were moving.
              But I never actually had a clear picture of what was happening underneath it all.
            </p>

            <p className="text-muted-foreground">
              The problem was simple. I wasn’t seeing my financial reality in real time.
              I only saw it at the end of the month… or worse, at tax season.
            </p>

            <p>
              That’s when things usually got uncomfortable.
              Not because the business wasn’t working, but because I didn’t actually know how it was working.
            </p>

            <p className="text-muted-foreground">
              I didn’t know where I was overspending. I didn’t know what was actually profitable.
              And I definitely didn’t know what decisions I should or shouldn’t be making.
            </p>

            <p>
              That experience changed how I think about accounting completely.
              It stopped being “record keeping” and started becoming something more important:
              <span className="text-emerald-500 font-medium"> decision-making clarity.</span>
            </p>

            <p className="text-muted-foreground">
              Now, while studying Accounting and Banking & Finance, I built Perugi Partners
              around a simple idea:
              business owners shouldn’t have to wait until tax season to understand their business.
            </p>

            <p className="font-medium">
              They should see it clearly, all the time.
            </p>
      ...
      {/* Mission / Vision */}
      <section className="w-full py-20 lg:py-28 bg-background">
        <div className="w-full px-6 lg:px-12 max-w-5xl mx-auto grid md:grid-cols-2 gap-8">

          <AnimatedSection className="p-8 rounded-3xl bg-card border border-border">
            <Target className="w-6 h-6 text-emerald-500 mb-4" />
            <h3 className="text-2xl font-bold mb-4">Mission</h3>
            <p className="text-muted-foreground">
              To help business owners understand their financial reality clearly enough to make better decisions every day, not just at the end of the year.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.1} className="p-8 rounded-3xl bg-card border border-border">
            ...
            <p className="text-muted-foreground">
              A world where entrepreneurs don’t guess their numbers; they see them clearly, act on them quickly, and grow with confidence.
            </p>
          </AnimatedSection>
        ...
        <div className="w-full px-6 lg:px-12 max-w-3xl mx-auto text-center">
          ...
          <AnimatedSection className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              It’s about knowing where your business stands while you still have time to change it.
            </p>

            <p className="text-emerald-500 font-medium">
              That’s what Perugi Partners was built for.
            </p>

            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-500 text-white font-semibold rounded-full hover:scale-105 transition mt-6"
            >
              Work With Us <ArrowRight className="w-4 h-4" />
            </Link>
